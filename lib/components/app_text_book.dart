...
Widget bodyRegular(BuildContext context) {
  debugPrint('UseCase ${WidgetbookState.of(context).queryParams} -- ${AppTheme.of(context).colors.onSurface}');
  return SafeAreaWrapper(
    child: AppText.bodyStandardRegular(
      'TEXT',
      color: context.knobs
          .color(label: 'Text color', initialValue: AppTheme.of(context).colors.onSurface),
    ),
  );
}
